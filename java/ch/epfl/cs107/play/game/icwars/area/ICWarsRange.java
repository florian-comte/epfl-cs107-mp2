...
public class ICWarsRange extends AreaGraph implements Graphics {
	...
	@Override
	public void addNode(DiscreteCoordinates coordinates, boolean hasLeftEdge, boolean hasUpEdge, boolean hasRightEdge,
			boolean hasDownEdge) {
		getNodes().putIfAbsent(coordinates,
	...
	private class RangeNode extends AreaNode implements Graphics {
		...
		private RangeNode(DiscreteCoordinates coordinates, boolean hasLeftEdge, boolean hasUpEdge, boolean hasRightEdge,
				boolean hasDownEdge) {
